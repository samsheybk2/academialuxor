...
-- ========================================
-- PASO 2: SEMBRAR COMPETENCIAS Y PREGUNTAS
-- ========================================
...
-- ========================================
-- PASO 3: POLÍTICAS DE ACCESO PÚBLICO
-- ========================================
DROP POLICY IF EXISTS "public_test_assignments_select" ON cst_test_asignaciones;
CREATE POLICY "public_test_assignments_select" ON cst_test_asignaciones
  FOR SELECT TO anon
  USING (true);

DROP POLICY IF EXISTS "public_test_competencias_select" ON cst_test_competencias;
CREATE POLICY "public_test_competencias_select" ON cst_test_competencias
  FOR SELECT TO anon
  USING (estado = 'activo');

DROP POLICY IF EXISTS "public_test_preguntas_select" ON cst_test_preguntas;
CREATE POLICY "public_test_preguntas_select" ON cst_test_preguntas
  FOR SELECT TO anon
  USING (true);

DROP POLICY IF EXISTS "public_test_resultados_insert" ON cst_test_resultados;
CREATE POLICY "public_test_resultados_insert" ON cst_test_resultados
  FOR INSERT TO anon
  WITH CHECK (true);

DROP POLICY IF EXISTS "public_test_resultados_update" ON cst_test_resultados;
CREATE POLICY "public_test_resultados_update" ON cst_test_resultados
  FOR UPDATE TO anon
  USING (true);

DROP POLICY IF EXISTS "public_test_asignaciones_update" ON cst_test_asignaciones;
