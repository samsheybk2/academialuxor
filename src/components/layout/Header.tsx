...
import { LogOut, LayoutDashboard, GraduationCap, Users, BookOpen, Route, Calendar, Bell, Check, Clock, ArrowLeft } from "lucide-react"
...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    ...
    <header className="sticky top-0 z-30 h-14 bg-white/80 backdrop-blur-md border-b border-gray-200 flex items-center px-4">
